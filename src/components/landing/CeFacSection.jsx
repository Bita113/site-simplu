  ...
  return (
    <section className="px-5 py-20 sm:py-28 bg-white">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-12">
          <h3 className="text-sm font-semibold uppercase tracking-widest text-[#EA580C] mb-6">
            Ce include un site
          </h3>
          <div className="space-y-4">
            {features.map((f, i) => (
              <div key={i} className="flex items-center gap-4">
                <div className="flex-shrink-0 w-9 h-9 rounded-lg bg-[#FFF7ED] border border-[#FED7AA] flex items-center justify-center">
                  <f.icon className="w-4 h-4 text-[#EA580C]" />
                </div>
        ...
        <div className="p-6 rounded-2xl bg-[#FFF7ED] border border-[#FED7AA]">
          <p className="text-base text-[#7C2D12] leading-relaxed">
